...
check("前端装配入口使用可独立加载的原生 ES modules",
      ...
      and b'./modules/media-source.js?v=20260916p127' in app_js
...
if chrome:
    ...
    browser_build_present = "20260916p127" in browser.stdout
...
check("产品介绍页使用九段双语用户旅程与虚构演示",
      ...
      and b'/static/fluent-foundation.css?v=20260916p127' in product_page
