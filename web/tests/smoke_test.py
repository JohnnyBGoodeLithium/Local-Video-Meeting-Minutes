...
check("前端装配入口使用可独立加载的原生 ES modules",
      ...
      and b'./modules/media-source.js?v=20260831p107' in app_js
...
if chrome:
    ...
    check("在线工作台 ES modules 在 Headless Chromium 完整启动",
          browser.returncode == 0 and "20260831p107" in browser.stdout
          ...
          f"rc={browser.returncode}, build={'20260831p107' in browser.stdout}, "
...
check("产品介绍页同步当前能力、双语与设计 token",
      ...
      and b'/static/fluent-foundation.css?v=20260831p107' in product_page
