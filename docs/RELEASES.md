...
当前发布基线为 `v0.12.0`（2026-08-27，Web p103）：产品介绍已与当前会议/媒体双入口、三项
核心能力、渐进处理、MeetingPack/KB/WeKnora 交接和统一内存护栏同步，并以同一 DOM 提供完整
中英双语阅读。知识库图文版保留图片，但外部 VLM 仍是可选消费能力，不属于 mandatory pipeline。
