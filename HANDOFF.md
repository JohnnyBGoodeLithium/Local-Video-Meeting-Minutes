...
更新时间：2026-08-31（产品版本 v0.15.0；在线工作台构建号 20260831p108；提交号以 `git log -1` 为准）

## 当前状态速览（2026-08-31）

**最新交付（v0.15.0 / p108，feature branch `feat/v0.15-workspace-ux`）**：
...
**部署边界**：代码和静态资源在 feature branch/tag 完成交付后，仍不自动重启本机服务。共享记忆记录 v0.14.2 的真实恢复任务曾被误中断；必须确认没有活跃作业并获得用户授权后，才能把本机服务切到 v0.15.0。未部署前浏览器仍可能显示 v0.14.2/p107。
