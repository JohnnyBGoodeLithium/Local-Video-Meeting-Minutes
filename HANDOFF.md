...
更新时间：2026-08-26（产品版本 v0.11.0；在线工作台构建号 20260826p95；提交号以 `git log -1` 为准）
...
- 待办队列：①按领域抽离 `app.js` 原生 ES modules ②公开链接用真实站点验收并在 LAN 前隔离下载 worker ③WeKnora API 直推 ④场内 AI 对话收缩为修正助手 ⑤知识库引用深链与 VLM 开/关 A/B 产品验收。
