...
更新时间：2026-08-18（产品版本 v0.8.2；在线工作台构建号 20260818p52；提交号以 `git log -1` 为准）
...
- 仅离线 MeetingPack 使用四入口与两态布局：会议脉络、会议纪要和屏幕内容使用全宽浏览布局；逐字稿进入左侧播放器/章节与说话人时间轴、右侧大面积逐字稿的核听态。在线工作台保持 p52 原布局。
